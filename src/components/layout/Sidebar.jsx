...
export default function Sidebar() {
  ...
  const todayDay = currentDayNumber(
    ...
    <aside className="hidden md:flex md:w-60 lg:w-64 shrink-0 flex-col border-r border-[rgb(var(--border-soft))] bg-[rgb(var(--surface))] h-screen sticky top-0">
      ...
      <div className="px-5 py-5 flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-[10px] text-[rgb(var(--text-dim))] mt-1">
            Daily goals. Real progress.
          </p>
        </div>
      </div>
      ...
      {/* PROGRESS CARD */}
      <div className="p-3 mx-3 mb-3 rounded-xl bg-[rgb(var(--surface-2))] border border-[rgb(var(--border-soft))]">

        <div className="flex items-center justify-between mb-1.5">

          <span className="text-[11px] font-medium text-[rgb(var(--text-muted))]">
            Day {todayDay} / {stats.duration}
          </span>
      ...
      <div className="px-3 pb-4">
        ...
        <button
          type="button"
          onClick={signOut}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-[rgb(var(--text-muted))] hover:text-red-500 hover:bg-red-500/10 transition-colors"
        >
